              ...
              >
                ...
                <div className="flex flex-wrap gap-2">
                  {category.skills.map((skill, skillIndex) => (
                    <span
                      key={skillIndex}
                      className="px-3 py-1 bg-gray-800 text-cyan-400 rounded-full text-sm border border-gray-700 hover:border-cyan-500 hover:bg-gray-700 transition-all duration-300"
                    >
                      {skill}
                    </span>
                  ))}
          ...
          <div className="inline-block bg-gray-900 rounded-xl p-8 border border-gray-700">
            ...
            <div className="flex flex-wrap justify-center gap-3">
              {['TypeScript', 'Next.js', 'MongoDB', 'Docker', 'AWS'].map((tech, index) => (
                <span
                  key={index}
                  className="px-4 py-2 bg-gradient-to-r from-cyan-500/10 to-blue-500/10 text-cyan-400 rounded-lg text-sm border border-cyan-500/30 font-medium"
                >
                  {tech}
                </span>
              ))}
